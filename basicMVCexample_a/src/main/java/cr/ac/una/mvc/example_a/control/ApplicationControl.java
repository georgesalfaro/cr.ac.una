package cr.ac.una.mvc.example_a.control;

import cr.ac.una.mvc.Observer;
import cr.ac.una.mvc.example_a.model.Model;
import cr.ac.una.mvc.example_a.model.ModelView;
...
public class ApplicationControl {
    ...
    public void register(Observer newObserver) {
        ...
        data.addObserver(newObserver);
    }

    public void remove(Observer current) {
