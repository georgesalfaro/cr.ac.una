package cr.ac.una.mvc.example_a;

import cr.ac.una.mvc.example_a.control.ApplicationControl;
import cr.ac.una.mvc.example_a.view.ApplicationWindow;
...
public class BasicExampleA {
    ...
    private void createAndShowGUI() {
        ...
        //
        new ApplicationWindow("Ejemplo Básico MVC (a)",
